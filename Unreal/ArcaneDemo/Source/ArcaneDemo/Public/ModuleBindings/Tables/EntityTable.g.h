...
class ARCANEDEMO_API UEntityEntityIdUniqueIndex : public UObject
{
    GENERATED_BODY()
...
private:
    ...
    FUniqueIndexHelper<FEntityType, FSpacetimeDBUuid, FTableCache<FEntityType>> EntityIdIndexHelper;
...
public:
    ...
    FEntityType Find(FSpacetimeDBUuid Key)
    {
...
class ARCANEDEMO_API UEntityTable : public URemoteTable
{
    GENERATED_BODY()
